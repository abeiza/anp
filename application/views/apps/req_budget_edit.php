					...
					$.ajax({
						...
						success:function(result){
							...
							$.each(result, function(i, data){
								if(data.CustomerID == '<?php echo $Kode_Distributor;?>'){
									$('#kode').append("<option value='"+data.CustomerID+"' selected>"+data.CustomerID+" - "+data.CustomerName+"</option>");
								}else{
								...
								success:function(result){
									...
									$.ajax({
										...
										success:function(result){
											...
											$.ajax({
												url:"<?php echo base_url();?>index.php/application/req_budget/update_total_header/",
												data:{
													object:$("#req_id").val(),
													qty:$("#total_unit").val(),
			...
			<div class="main">
				<div class="container">
					<div style="padding:20px 0px;">
						<h3 style="color:#808CA0;display:inline;"><i class="fa fa-pencil" style="margin-right:5px;font-size:14px; border:1px solid #808CA0;border-radius:100px;padding:10px 12px;"></i>Edit Request Budget</h3>
						...
						?>	
							...
							<div style="width:50%;float:left;">
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<input class="input-text-login" style="width:70%" type="text" name="req_no" value="<?php echo $Req_No;?>"/>
									<input class="input-text-login" style="width:50%" type="hidden" name="req_id" id="req_id" value="<?php echo $Req_ID; ?>"/>
								</div>
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<select class="input-text-login" style="width:70%" name="brand">
										...
										<?php foreach($query_brand->result() as $brand){
											...
											if($brand->ID_Brand == $ID_Brand) echo "selected";
								...
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<input class="input-text-login" style="width:70%" type="text" name="req_by" value="<?php echo $Req_By;?>"/>
								</div>
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<input class="input-text-login" style="width:70%" type="text" name="manage_by" value="<?php echo $Manage_By;?>"/>
								</div>
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<select class="input-text-login" style="width:70%" name="program">
										...
										<?php foreach($query_program->result() as $program){
											echo "<option value='".$program->ID_Program."'";
											if($program->ID_Program == $ID_Program) echo "selected";
											echo">".$program->Sub_Program_Type."</option>";
										}?>
									</select>
								</div>
							</div>
							<div style="width:50%;float:left;">
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<input class="input-text-login" style="width:70%;background-color:#f5f5f5;" type="text" name="period_start" id="period_start" value="<?php echo $Period_Start;?>" readonly/>
								</div>
								<div style="width:100%;float:left;margin:3px 0px;">
									...
									<input class="input-text-login" style="width:70%;background-color:#f5f5f5;" type="text" name="period_end" id="period_end" value="<?php echo $Period_End;?>" readonly/>
								</div>
								<div style="width:100%;float:left;margin:3px 0px;">
							...
							<div style="width:50%;float:right;">
								...
								<div style="width:100%;float:right;">
									<button type="submit" class="btn default" style="float:right;margin-right:5%;" name="request"><i class="fa fa-edit" style="margin-right:5px;"></i>Process</button>
								</div>
							</div>
							<div style="width:50%;float:right;">
								<div style="padding-left:23%;color:#FF6B6B !important"><h6><i class="fa fa-info-circle"></i> Field yang bertanda * harus diisi.</h6></div>
							</div>
							<div style="width:50%;float:right;">
