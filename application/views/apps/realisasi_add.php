...
<div class="main">
	<div class="container">
		<div style="padding:20px 0px;">
			<h3 style="color:#808CA0;display:inline;"><i class="fa fa-plus" style="margin-right:5px;font-size:14px; border:1px solid #808CA0;border-radius:100px;padding:10px 12px;"></i>Add Budget Realisation #<?php echo $this->uri->segment(4);?></h3>
		...
		<div style="width:100%;background-color:#fff;padding:10px 10px;float:left;">
			<?php echo form_open('application/req_realisasi/add_action/'.$this->uri->segment(4));?>
				<div style="width:100%;background:#fff;float:left;">
					<div class="click" style="width:100%;float:left;cursor:pointer;background-color:#f5f5f5;border-radius:3px;">
					...
					<div style="width:50%;float:left;">
						...
						<div style="width:100%;float:left;">
							...
							<input id="real1" type="hidden" style="width:30%;float:left;border:1px solid #fff;background-color:#f5f5f5;padding:5px;margin:2px;border-radius:3px;" readonly value="<?php if($db->Real_Amount == '' or $db->Real_Amount == 0){echo '0';}else{echo $db->Real_Amount;}?>"/>
						</div>
						<div style="width:100%;float:left;">
				...
				<div style="width:100%;background:#fff;float:left;">
					...
					<div style="padding:20px;float:left;">
						<div style="width:100%;float:left;">
							...
							<input class="input-text-login" style="width:30%;margin:2px 0px;background-color:#f5f5f5;" readonly type="text" name="TglTrans" id="TglTrans"/>
							<div class="code" style="color:#FF6B6B;"><?php echo form_error('TglTrans'); ?></div>
						</div>
						<!--<div style="width:100%;float:left;">
							<div style="width:10%;float:left;">Seq No. </div>	
							<input class="input-text-login" style="width:70%;margin:2px 0px;" type="text" name="Seq_No"/>
						</div>-->
						<div style="width:100%;float:left;">
							<div style="width:10%;float:left;">Real Price* </div>	
							<input type="number" class="input-text-login" style="width:30%;margin:2px 0px;text-align:right" name="Real_Price" id="price" onchange="findTotal();bugetOver();"/>
							<div class="code" style="color:#FF6B6B;"><?php echo form_error('Real_Price'); ?></div>
						</div>
						<div style="width:100%;float:left;">
							<div style="width:10%;float:left;">Unit* </div>	
							<input type="number" class="input-text-login" style="width:30%;margin:2px 0px;text-align:right" name="Real_Unit" id="unit" onchange="findTotal();bugetOver();"/>
							<div class="code" style="color:#FF6B6B;"><?php echo form_error('Real_Unit'); ?></div>
						</div>
						<div style="width:100%;float:left;">
							<div style="width:10%;float:left;">Amount* </div>	
							<input class="input-text-login" style="width:30%;margin:2px 0px;text-align:right;background-color:#e5e5e5" id="total" name="Real_Amount" readonly/>
							<div id="sta" class="code"></div>
							<div class="code" style="color:#FF6B6B;"><?php echo form_error('Real_Amount'); ?></div>
						</div>
						<div style="width:100%;float:left;">
							<div style="width:10%;float:left;">&nbsp;</div>	
							<button type="submit" class="btn default" style="margin-right:5%;" name="realisasi"><i class="fa fa-check" style="margin-right:5px;"></i>Process</button>
						</div>
					</div>
				</div>
			<?php echo form_close();?>
	...
	<script type="text/javascript">
		...
		function bugetOver(){
			if(document.getElementById("budget").value < parseInt(document.getElementById("real1").value)+parseInt(document.getElementById("total").value)){
				$("#sta").empty();
				$("#sta").append("<div class='code' style='color:#FF6B6B;'><i class='fa fa-ban' style='margin-right:5px;'></i>Insufficient Funds</div>");
			}else{
				//alert(document.getElementById("real1").value);
				$("#sta").empty();
