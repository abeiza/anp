			<div class="main">
				<div class="container">
					<div style="padding:20px 0px;">
						<h3 style="color:#808CA0;display:inline;"><i class="fa fa-bookmark" style="margin-right:5px;font-size:14px; border:1px solid #808CA0;border-radius:100px;padding:10px 12px;"></i>Request Budget</h3>
						<div style="display:inline; color:#666;padding:5px 15px;background-color:#fff;margin-left:20px;font-size:14px;border:1px solid #e1e1e1;border-radius:15px"><a style="color:#808CA0;text-decoration:none;" href="<?php echo base_url().'index.php/application/req_budget/grid_modify/';?>"><i class="fa fa-edit"></i> Budget Modify</a></div>
						<div style="display:inline; color:#666;padding:5px 15px;background-color:#fff;margin-left:0px;font-size:14px;border:1px solid #e1e1e1;border-radius:15px"><a style="color:#808CA0;text-decoration:none;" href="<?php echo base_url();?>index.php/application/req_budget/upload_data/"><i class="fa fa-upload"></i> Budget Upload</a></div>
					...
					<div id="body">
						<?php 
							...
							$phpgrid->set_col_currency("Total_Unit", "", "", ",", 0, "");
							$phpgrid->set_col_title("Total_Amount", "Amount");
							$phpgrid->set_col_currency("Total_Amount", "IDR ", "", ",", 2, "0.00");
							...
							$phpgrid->set_col_property("Total_Unit", array("formoptions"=>array("rowpos" => 11, "colpos" => 1)));
							$phpgrid->set_col_property("Total_Amount", array("formoptions"=>array("rowpos" => 12, "colpos" => 1)));
