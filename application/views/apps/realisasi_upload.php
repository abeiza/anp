			...
			<div class="main">
				<div class="container">
					<div style="padding:20px 0px;">
						<h3 style="color:#808CA0;display:inline;"><i class="fa fa-upload" style="margin-right:5px;font-size:14px; border:1px solid #808CA0;border-radius:100px;padding:10px 12px;"></i>Realisation Upload</h3>
						...
						<div style="display:inline; float:right;color:#808CA0;padding:5px 15px;margin-left:20px;font-size:14px;"><span><i class="fa fa-at" style="margin-right:2px;font-size:12px;"></i>Realisation Budget <i style="font-size:12px;padding:0px 10px;" class="fa fa-angle-double-right"></i>Realisation Upload</span></div>
					</div>
					<style>
						.foo {
							display: block;
					...
					<div style="border:1px dashed #bcbcbc;height:300px;margin-bottom:50px;display: -webkit-flex; /* Safari */
						...
						<?php 
							...
							echo form_open_multipart('application/req_realisasi/proses_upload',$attribute);
						?>
